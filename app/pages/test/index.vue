<template>
    <div class="page-root">
        ...
        <div class="relative flex w-full h-[calc(100vh-400px)] max-w-7xl justify-start items-center">
            <svg ref="svgEl" viewBox="0 0 400 150" class="w-full max-w-2xl overflow-visible">
                <defs>
                    ...
                    <clipPath id="intro-text-clip">
                        <text x="50%" y="115" text-anchor="middle" font-size="80" font-weight="700" font-family="Montserrat, sans-serif">Building</text>
                    </clipPath>
                    <mask id="fill-mask">
                ...
                <g clip-path="url(#intro-text-clip)">
                    <text x="50%" y="115" text-anchor="middle" font-size="80" font-weight="700" font-family="Montserrat, sans-serif" class="intro-stroke-1">Building</text>
                    <text x="50%" y="115" text-anchor="middle" font-size="80" font-weight="700" font-family="Montserrat, sans-serif" class="intro-stroke-2">Building</text>
                    <text x="50%" y="115" text-anchor="middle" font-size="80" font-weight="700" font-family="Montserrat, sans-serif" class="intro-stroke-3">Building</text>
                </g>
                ...
                <g clip-path="url(#cursor-clip)" style="pointer-events: none">
                    <text x="50%" y="115" text-anchor="middle" font-size="80" font-weight="700" font-family="Montserrat, sans-serif" class="stroke-1">Building</text>
                    <text x="50%" y="115" text-anchor="middle" font-size="80" font-weight="700" font-family="Montserrat, sans-serif" class="stroke-2">Building</text>
                    <text x="50%" y="115" text-anchor="middle" font-size="80" font-weight="700" font-family="Montserrat, sans-serif" class="stroke-3">Building</text>
                </g>
            </svg>
        </div>
    </div>
...
function resizeCanvases() {
    ...
    canvasW = w
    canvasH = h
    ;[grainCanvas, layer0Canvas, layer1Canvas, layer2Canvas].forEach(r => {
        if (!r.value) return
        r.value.width  = w
        r.value.height = h
    })
...
.intro-stroke-1 { stroke-width: 4; opacity: 1; animation: draw-stroke 10.8s ease forwards 0s; }
.intro-stroke-2 { stroke-width: 4; opacity: 1; animation: draw-stroke 20.8s ease forwards 0.1s; }
.intro-stroke-3 { stroke-width: 4; opacity: 1; animation: draw-stroke 30.8s ease forwards 0.2s; }
